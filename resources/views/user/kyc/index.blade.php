<x-layouts.dashboard.user>
    ...
    <div class="nk-block">
        <div class="card card-bordered">
            <form id="kyc-verify" action="{{ route('user.submit.kyc') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="nk-kycfm">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-group">
                                        <input type="text" name="dob" id="dob" class="form-control form-control-lg date-picker-alt">
                                    </div>
                                </div>
                            </div><!-- .col -->
                            <!-- <div class="col-md-6">
                    ...
                    <div class="nk-kycfm-content">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="form-label-group">
                                        <label for="address_alt" class="form-label">Address Line 2</label>
                                    </div>
                                    <div class="form-control-group">
                                        <input type="text" name="address_alt" id="address_alt" class="form-control form-control-lg">
                                    </div>
                                </div>
                            </div><!-- .col -->
                            <div class="col-md-6">
                    ...
                    <div class="nk-kycfm-head">
                        ...
                        <div class="nk-kycfm-title">
                            <h5 class="title">Document Selfie</h5>
                    ...
                    <div class="nk-kycfm-content">
                        ...
                        <ul class="list list-sm list-checked">
                            ...
                            <li>Selfie must be under light</li>
                        </ul>
                        <div class="nk-kycfm-upload">
                            ...
                            <div class="row align-items-center">
                                <div class="col-sm-8">
                                    <div class="form-group">
                                        <label class="form-label" for="customFileLabel">Selfie</label>
                                        <div class="form-control-wrap">
                                            <div class="form-file">
                                                <input type="file" name="selfie" class="form-file-input" id="selfie">
                                                <label class="form-file-label" for="selfie">Choose file</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4 d-none d-sm-block">
                                    <div class="mx-md-4">
                                        <img src="{{ asset('assets/images/icons/file-media.svg') }}" alt="selfie">
                                    </div>
                                </div>
                            </div>
                        </div><!-- nk-kycfm-upload -->
                    ...
                    <div class="nk-kycfm-content">
                        ...
                        <ul class="nk-kycfm-control-list g-3">
                            <li class="nk-kycfm-control-item">
                                <input class="nk-kycfm-control" type="radio" name="document_type" id="passport" data-title="Passport" value="Passport" checked>
                            ...
                            <li class="nk-kycfm-control-item">
                                <input class="nk-kycfm-control" type="radio" name="document_type" id="national-id" data-title="National ID" value="National ID">
                        ...
                        <div class="nk-kycfm-upload">
                            ...
                            <div class="row align-items-center">
                                <div class="col-sm-8">
                                    <div class="form-group">
                                        <label class="form-label" for="customFileLabel">Front of Selected Document</label>
                                        <div class="form-control-wrap">
                                            <div class="form-file">
                                                <input type="file" name="document_front" class="form-file-input" id="document_front">
                                                <label class="form-file-label" for="document_front">Choose file</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4 d-none d-sm-block">
                                    <div class="mx-md-4">
                                        <img src="{{ asset('assets/images/icons/id-front.svg') }}" alt="ID Front">
                                    </div>
                                </div>
                            </div>
                        </div><!-- nk-kycfm-upload -->
                        <div class="nk-kycfm-upload">
                            ...
                            <div class="row align-items-center">
                                <div class="col-sm-8">
                                    <div class="form-group">
                                        <label class="form-label" for="customFileLabel">Back of Document</label>
                                        <div class="form-control-wrap">
                                            <div class="form-file">
                                                <input type="file" name="document_back" class="form-file-input" id="document_back">
                                                <label class="form-file-label" for="document_back">Choose file</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4 d-none d-sm-block">
                                    <div class="mx-md-4">
                                        <img src="{{ asset('assets/images/icons/id-back.svg') }}" alt="ID Back">
                                    </div>
                                </div>
                            </div>
                        </div><!-- nk-kycfm-upload -->
                    ...
                    <div class="nk-kycfm-footer">
                        <div class="form-group">
                            <div class="custom-control custom-control-xs custom-checkbox">
                                <input type="checkbox" name="terms" class="custom-control-input" id="tc-agree">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-control-xs custom-checkbox">
                                <input type="checkbox" name="affirm" class="custom-control-input" id="info-assure">
        ...
        $(function() {
            $('#kyc-verify').validate({
                ...
                errorPlacement: function(error, element) {
                    if (element.attr("type") == "checkbox" || element.attr("type") == "file") {
                        error.css({color: '#e85347', 'font-size': '11px', 'font-style': 'italic'});
            ...
            const ajaxOptions = {
                ...
                success: function(response) {
                    ...
                    $('#kyc-verify').find('button').attr('disabled', false)
                },
                error: function(XMLHttpRequest, textStatus, errorThrown) {
                    ...
                    for (let key in errors) {
                        if (errors.hasOwnProperty(key)) {
                            let key = $(`#${key}`).addClass('is-invalid');
                            $(`<span class="invalid-feedback" role="alert">${errors[key][0]}</span>`).insertAfter(key);
                        } 

                    ...
                    <div class="nk-wgw">
                        <div class="nk-wgw-inner">
                            ...
                            <div class="nk-wgw-balance">
                                ...
                                <div class="amount-sm">{{ $balance }}<span class="currency currency-usd">USD</span></div>
                                <div class="amount-sm">{{ $ledger_balance }}<span class="currency currency-usd">USD</span></div>
                            </div>
                        </div>
                        <div class="nk-wgw-actions">
                            <ul>
                                <li><a href="{{ route('user.transfer') }}"><em class="icon ni ni-arrow-up-right"></em> <span>Send</span></a></li>
                                <li><a href="{{ route('user.deposit') }}"><em class="icon ni ni-arrow-down-left"></em><span>Deposit</span></a></li>
                                <li><a href="{{ route('user.withdraw') }}"><em class="icon ni ni-arrow-to-right"></em><span>Withdraw</span></a></li>
                            </ul>
                        </div>

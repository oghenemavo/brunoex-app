    ...
    <x-slot name="header">
        ...
        <div class="nk-block-between-md g-4">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title fw-normal">Deposit</h3>
            ...
            <div class="card card-bordered h-100">
                <div class="col-lg-8">
                    <div class="card-inner">
                        <form id="deposit" action="{{ route('user.make.deposit') }}">
                            @csrf
        ...
        $(function() {
            ...
            const ajaxOptions = {
                ...
                success: function(response) {
                    ...
                    $('#deposit').find('button').attr('disabled', true)
                },
                error: function(XMLHttpRequest, textStatus, errorThrown) {
                    ...
                    $('#deposit').find('button').attr('disabled', false);

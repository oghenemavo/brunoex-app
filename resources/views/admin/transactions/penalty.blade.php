    ...
    <x-slot name="header">
        ...
        <div class="nk-block-between-md g-4">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title fw-normal">Penalty</h3>
                <div class="nk-block-des">
                    <p>Debit fiat from user wallet.</p>
                </div>
            </div>
        </div>
    </x-slot>
            ...
            <div class="card card-bordered h-100">
                <div class="col-lg-8">
                    <div class="card-inner">
                        <form id="add-penalty" action="{{ route('admin.add.penalty') }}">
                            @csrf
    ...
    <script>
        ...
        const ajaxOptions = {
            ...
            success: function(response) {
                ...
                $('#add-penalty').find('button').attr('disabled', false)
            },

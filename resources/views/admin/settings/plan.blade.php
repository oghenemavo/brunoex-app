<form action="{{ route('admin.plans.store') }}" method="POST">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <input type="text" id="plan_name" class="form-control" name="plan_name" required>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <input type="number" id="profit" class="form-control" name="profit" min="0.1" max="100" step="0.01" required>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <input type="number" id="min_deposit" class="form-control" name="min_deposit" min="0.1" step="0.01" required>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <input type="number" id="max_deposit" class="form-control" name="max_deposit" min="0.1" step="0.01" required>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <input type="number" id="duration" class="form-control" name="duration" min="1" step="1" required>

...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="js">
    <head>
        ...
        <meta name="description" content="Crypto Exchange, Loans and Investment."><!-- Fav Icon  -->
        <link rel="shortcut icon" href="./images/favicon.png">
        <!-- Page Title  -->
        <title>Dashboard | Brunoex Admin Dashboard</title>
        <!-- StyleSheets  -->
                                        ...
                                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-end dropdown-menu-s1">
                                            ...
                                            <div class="dropdown-inner">
                                                <ul class="link-list">
                                                    ...
                                                    <li><a href="{{ route('admin.profile.settings') }}"><em class="icon ni ni-setting-alt"></em><span>Account Setting</span></a></li>

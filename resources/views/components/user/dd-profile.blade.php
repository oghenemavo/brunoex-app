...
<li class="dropdown user-dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-md dropdown-menu-end dropdown-menu-s1">
        ...
        <div class="dropdown-inner user-account-info">
            ...
            <div class="user-balance">{{ $user->wallet->balance }} <small class="currency currency-usd">USD</small></div>
            <div class="user-balance-sub">Locked <span>{{ $user->wallet->ledger_balance }} <span class="currency currency-usd">USD</span></span></div>
